...
(function () {
    ...
    ///////////////////////////////////////
    // Critical Hit Dice Helper Function //
    ///////////////////////////////////////
    ...
    function  randomCritZone() {
      // declares a random 'zone'
      return ['Head', 'Left Shoulder', 'Right Shoulder', 'Left Forearm', 'Right Forearm', 'Left Hand', 'Right Hand', 'Torso', 'Waist', 'Left Thigh', 'Right Thigh', 'Left Ankle', 'Right Ankle', 'Left Foot', 'Right Foot', 'Eyes', 'Ears', 'Nose', 'Throat']
      [random(0, 18)];
    }

    function randomCritEffect() {
      // declares a random 'condition'
      return ['Blinded', 'Broken', 'Confused', 'Cowering', 'Dazed', 'Dazzled', 'Deafened', 'Entangled', 'Exhausted', 'Fascinated', 'Fatigued', 'Flat-Footed', 'Nauseated', 'Panicked', 'Paralyzed', 'Shaken', 'Sickened', 'Staggered', 'Stunned']
      [random(0, 18)];
    }
